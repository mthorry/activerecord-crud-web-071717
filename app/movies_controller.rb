...
def can_be_instantiated_and_then_saved
  movie = Movie.new # instantiated
  movie.title = "This is a title." # given a title
  movie.save # saved to database?
end
...
def can_find_the_first_item_from_the_database_using_id
  # binding.pry
  Movie.all.find { |movie| movie.id == 1}.title
end
...
def can_update_using_update_method
  ...
  # binding.pry
  Movie.first.update(title: "Wat, huh?")
end
